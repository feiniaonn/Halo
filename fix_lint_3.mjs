...
for (const fix of fixes) {
  ...
  // Clean irregular whitespaces
  content = content.replace(/\\u3000|\\u200B|\\u00A0|\\uFEFF/g, ' ');
  
  // Actual targeted fixes
  ...
  content = content.replace(/setLivePosition\\(null\\);/g, '// eslint-disable-next-line react-hooks/set-state-in-effect\\n      setLivePosition(null);');
