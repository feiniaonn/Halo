...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            media_cmds::list_vod_parse_rankings,
            media_cmds::list_vod_parse_health_records,
            media_cmds::load_vod_aggregate_search_cache,
            media_cmds::save_vod_aggregate_search_cache,
            media_cmds::load_vod_playback_resolution_cache,
            media_cmds::save_vod_playback_resolution_cache,
            media_cmds::load_vod_detail_cache,
            media_cmds::save_vod_detail_cache,
            media_cmds::load_vod_dispatch_cache,
            media_cmds::save_vod_dispatch_cache,
            media_cmds::load_vod_dispatch_backend_stats,
            media_cmds::record_vod_parse_success,
            media_cmds::record_vod_parse_health_success,
            media_cmds::record_vod_parse_health_failure,
            media_cmds::record_vod_dispatch_backend_success,
            media_cmds::record_vod_dispatch_backend_failure,
